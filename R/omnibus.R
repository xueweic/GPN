...
#' Modified omnibus (Chi-square) test
#'
#' Omnibus test for testing the association between K phenotypes with a SNP. The phenotypes can be either qualitative or binary, espectially the binary phenotypes with the extremely case-control ratio (the test statistics has been adjusted by the saddlepoint approximation)
#'
#'
...
#'
#' @return p-value of the omnibus test statistic
#' @export
#'
#' @examples
#' N <- 10000
